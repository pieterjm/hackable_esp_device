...
*/
/**************************************************************************/
FileHandler::FileHandler(ESP8266WebServer *server) {
    debugln("File handler created.");
}
...
*/
/**************************************************************************/
void FileHandler::initialize(ESP8266WebServer *server) {
    /*
    ...
    */
    ...
    server->on("/upload", HTTP_POST, []() {
      ...
      }, this->handleFileUpload                                                   //Receive and save the file
    );
    /* Route for file upload request */
