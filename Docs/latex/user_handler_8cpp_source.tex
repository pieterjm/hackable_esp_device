...
\DoxyCodeLine{\Hypertarget{user_handler_8cpp_source_l00033}00033     File configFile = SPIFFS.open(HTTP\_CONFIG\_LOCATION, \textcolor{stringliteral}{"{}r"{}});}
...
\DoxyCodeLine{\Hypertarget{user_handler_8cpp_source_l00038}00038     \textcolor{keywordflow}{for}(uint8\_t i = 0; i < MAX\_NUMBER\_USERS*USER\_INFO\_LENGTH; i+=USER\_INFO\_LENGTH) \{}
...
\DoxyCodeLine{\Hypertarget{user_handler_8cpp_source_l00085}00085     \textcolor{keywordflow}{if} (permissionLevel == PERMISSION\_LVL\_ALL) \{}
