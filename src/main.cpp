...
/**************************************************************************/
/*!
  @brief    Returns a file not found response
*/
/**************************************************************************/
void handleFileNotFound(String path) {
    debugln(String("File Not Found: ") + path);                             //If the file doesn't exist, return false
    server.send(404, "text/plain", "404: Not Found");                       //Respond with a 404 (Not Found) error
}
...
/**************************************************************************/
/*!
  @brief    Handles the file upload to the LittleFS.
*/
/**************************************************************************/
...
/**************************************************************************/
/*!
  @brief    Handles the file download to the LittleFS.
*/
/**************************************************************************/
