...
/**************************************************************************/
/*!
  @brief    Encrypts the LittleFS file if it exists.
...
bool CbcEncryptor::encryptFile(String filename) {
    ...
    File inputFile = LittleFS.open(filename, "r");                            //Plaintext file
    File tmpFile = LittleFS.open("tmp_" + filename, "w");                     //Temporary file to store encrypted part
    ...
    LittleFS.remove(filename);                                                //Remove plain text file
    LittleFS.rename("tmp_" + filename, filename);                             //Rename tmp file
    return true;
}

/**************************************************************************/
/*!
  @brief    Decrypts the LittleFS file if it exists.
...
bool CbcEncryptor::decryptFile(String filename) {
    ...
    File tmpFile = LittleFS.open("tmp_" + filename, "w");
